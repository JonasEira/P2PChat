...
public class ConnPoint implements SoundWatcher{
    ...
    public static final int SOUND_DATA_ID = 1, TEXT_ID = 2;
    ...
    public void connect(){
        try {
            ...
            System.out.println("Starting Receive Thread for user: " + this._name);
            receiveThread.start();
            
            _ssThreadObject = new SendSocketThreadObject(_rsThreadObject.getOutputStream(), this);
